...
(0, _shoppingCartJs.addToCart)("Apple", 150);
console.log((0, _shoppingCartJs.totalPrice), (0, _shoppingCartJs.tq));
_shoppingCartJs.addToCart("Orange", 250);
(0, _shoppingCartJsDefault.default)("Lemon", 50);
/* 
...
*/ const deepClone = (0, _cloneDeepJsDefault.default)(state);
deepClone.user.loggedIn = true;
console.log(deepClone); // This deepClone object values now point to a different value (in the heap) from the object in which the copy was made from.
 // ===================================================================================================================================
...
exports.default = (product, quantity)=>{
    cart.push({
        product,
        quantity
    });
...
},{"./_getTag.js":"1kCom","./isObjectLike.js":"iad76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2mNKm","6rimH"], "6rimH", "parcelRequiref743")
